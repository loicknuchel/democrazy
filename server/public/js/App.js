				...
				if(elections[i]['results'][0] != null){
					...
					scrutinHTML = '<div class="grid col-300'+fit+'">'
						+ '<div class="scrutin" id="'+election['electionId']+'">'
							+ '<div class="name">'
								+ '<h3><a href="scrutins#scrutin'+election['electionId']+'" target="'+election['electionId']+'" title="Explications du scrutin"><img src="img/info32.png" /></a> '+election['electionType']+'</h3>'
							+ '</div>'
							+ '<div class="results">'
								+ '<ul>';
						var maxPc = 0;
